...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $db->prepare("UPDATE users SET full_name = ?, ttl = ?, phone = ?, gender = ? WHERE id = ?");
    $stmt->execute([$full_name, $ttl, $phone, $gender, $user['id']]);
...
<body class="bg-[#dce9f8] min-h-screen">
    <div class="flex flex-col items-center py-10">
        ...
        <!-- Hello -->
        <h1 class="mt-4 text-xl italic">Hallo Ozan</h1>
        ...
        <div class="bg-white shadow-lg rounded-lg mt-6 p-8 w-[90%] max-w-xl">
            ...
            <form action="" method="POST" class="space-y-4">
                ...
                <!-- NIS -->
                <div class="flex items-center">
                    <label class="w-32 text-gray-700">NIK :</label>
